...
public class MailController {
	...
	public SingleResult<String> saveLocation(@RequestBody MemberDTO.TempoPw dto) {
		...
		ResponseDTO.MemberResponse entity = memberService.tempoPw(dto.getMemberId(), dto.getPwQuestion(), dto.getPwAnswer());

		if (entity != null) {
			mailService.sendEmail(entity.getEmail(), "임시 비밀번호 안내 메일입니다:)", "임시로 발급된 비밀번호는 " + entity.getPw() + "입니다.");
